      ...
      <section className="team-dark-editorial-section">
        <div className="container">
          <div className="dark-editorial-header">
            <div className="dark-editorial-left">
              <span className="dark-editorial-eyebrow">
                <span className="eyebrow-num">02</span> HOW WE WORK TOGETHER
              </span>
            ...
            <div className="dark-editorial-desc-wrap">
              <p className="dark-editorial-desc-main">
                At WEXLYE, strategy, creativity, technology, and growth work together as one connected team. We bring different areas of expertise into a single process to create digital experiences that are clear, effective, and built to grow.
              </p>
              <p className="dark-editorial-desc-sub">
                From shaping the initial idea to designing the experience, developing the platform, and creating opportunities for growth, every project is approached collaboratively with a shared focus on the result.
              </p>
            </div>
          </div>
          ...
          <div className="dark-capabilities-grid">
            <div className="capability-item">
              ...
              <p className="capability-desc">
                We define clear goals, positioning, and digital direction before the work begins.
              </p>
            </div>
            <div className="capability-item">
              ...
              <p className="capability-desc">
                We create thoughtful visual systems and user experiences that make brands easier to understand and remember.
              </p>
            </div>
            <div className="capability-item">
              ...
              <p className="capability-desc">
                We build fast, scalable, and reliable digital experiences with clean, modern technology.
              </p>
            </div>
            <div className="capability-item">
              <span className="capability-num">04</span>
              <h4 className="capability-title">Marketing</h4>
              <p className="capability-desc">
                We connect brands with the right audiences through focused digital marketing and communication.
              </p>
            </div>
            <div className="capability-item">
              <span className="capability-num">05</span>
              <h4 className="capability-title">Growth</h4>
              <p className="capability-desc">
                We turn digital foundations into long-term opportunities for visibility, engagement, and business growth.
              </p>
            </div>
          </div>
        </div>
